...
class ClassicHeader extends RefreshIndicator {
  ...
  const ClassicHeader({
    ...
    this.releaseText: 'Zum Aktualisieren loslassen',
    this.refreshingText: 'Aktualisiere...',
    this.canTwoLevelIcon,
    this.twoLevelView,
    this.canTwoLevelText: 'release to enter secondfloor',
    this.completeText: 'Fertig!',
    this.failedText: 'Aktualisierung fehlgeschlagen',
    this.idleText: 'Zum Aktualisieren ziehen',
